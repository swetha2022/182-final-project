...
python3 experiments/pretraining.py --rank=0 --seed=42 --path="datasets" --epoch=45 --dataset="omniglot" --lr=0.0001 --name="baseline" --save_interval=15 --eval_interval=5 --gpu=7
...
python3 experiments/finetuning.py --rank=0 --seed=42 --path="datasets" --epoch=45 --dataset="omniglot" --lr=0.0001 --name="baseline-gpu" --save_interval=15 --eval_interval=1 --gpu=7 --model_path="checkpoints/pretrain_omniglot/baseline-gpu/checkpoint_45.pt"
